...
namespace photoGalleryApp.Droid
{
    public class PhotoImporter : IPhotoImporter
    {
        ...
        private async Task<bool> Import()
        {
            ...
            if (MainActivity.Current.CheckSelfPermission(Manifest.Permission.ReadExternalStorage) == Android.Content.PM.Permission.Granted)
            {
            ...
            return MainActivity.Current.CheckSelfPermission(Manifest.Permission.ReadExternalStorage) == Android.Content.PM.Permission.Granted;
        }
    }
}
